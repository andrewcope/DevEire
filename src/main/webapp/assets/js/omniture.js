...
s.linkInternalFilters="javascript:,hallmarkchannel.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"
s.successfulSearchEvent = 'event1';
s.nullSearchEvent = 'event8';
s.searchTermVariable = 'eVar7';
//s._channelDomain="Social Networks|facebook.com,myspace.com,twitter.com,linkedin.com>Social Media|digg.com,del.icio.us"
s._channelDomain="Social Networks|facebook.com,myspace.com,twitter.com,linkedin.com>Social Media|digg.com,del.icio.us>Partners| insidehallmarkchannel.com,hallmarkchannelpress.com,hallmarkmoviechannelpress.com,hallmark.com,hallmarkchannelus.com,hallmarkmoviechannel.com,crownmedia.net,crownmediaholdings.com"
s._channelParameter="RSS|rss>Newsletter|nlcid,nlid>"
s._channelPattern="Distributed Content|dst,dist>Email|em:"
...
s.useCommerce=true
s.varUsed="eVar19"
s.eventList="event9,event10,event11" //Abandon,Success,Error
...
/* Site Search */
if(!s.prop7) {
	s.prop7=s.getQueryParam('keyword')
...
var t_search=s.getValOnce(s[s.searchTermVariable],'ev7',0)
if(t_search=='')
{	
...
s.prop14=s.getPreviousValue(s.pageName,'gpv_pN','event1');
...
/* Plugin: getVisitNum 3.0 */
	s.prop18=s.getVisitNum(365);
	s.prop18=s.getVisitNum('w','s_vnum','s_invisit');
	s.prop18=s.getVisitNum('m','s_vmonthnum','s_monthinvisit');
	s.prop18=s.getVisitNum('d');
...
s.channelManager('cmpid,cid',':','s_cm','1');
	s.eVar20=s._referrer
	s.eVar21=s._referringDomain
	s.eVar22=s._partner
...
/* non-custom list */
s.seList="alltheweb`|query,q|All The Web>altavista.co|q,r|AltaVista>search.aol`,search.aol.ca|query,q|AOL.com Search>ask`,ask.co.uk|ask,q|Ask Jeeves>www.baidu`|wd,word|Baidu>eniro.se|search_word|Eniro#Sweden>g%.co,g%syndication`|q,*|G%>g%`.ag|q,*|G%#Antigua and Barbuda>g%`.ar|q,*|G%#Argentina>g%`.au|q,*|G%#Australia>g%.at|q,*|G%#Austria>g%.be|q,*|G%#Belgium>g%`.bz|q,*|G%#Belize>g%.ba|q,*|G%#Bosnia-Hercegovina>g%`.br|q,*|G%#Brasil>g%.bg|q,*|G%#Bulgaria>g%.ca|q,*|G%#Canada>g%.cl|q,*|G%#Chile>g%`.co|q,*|G%#Colombia>g%.co.cr|q,*|G%#Costa Rica>g%.hr|q,*|G%#Croatia>g%.dk|q,*|G%#Denmark>g%`.eg|q,*|G%#Egypt>g%.ee|q,*|G%#Estonia>g%.fr|q,*|G%#France>g%.de|q,*|G%#Germany>g%`.hk|q,*|G%#Hong Kong>g%.hu|q,*|G%#Hungary>g%.co.in|q,*|G%#India>g%.co.id|q,*|G%#Indonesia>g%.ie|q,*|G%#Ireland>g%.co.il|q,*|G%#Israel>g%.it|q,*|G%#Italy>g%`.jm|q,*|G%#Jamaica>g%.jo|q,*|G%#Jordan>g%.co.kr|q,*|G%#Korea>g%.lv|q,*|G%#Latvia>g%.lt|q,*|G%#Lithuania>g%.lu|q,*|G%#Luxembourg>g%`.my|q,*|G%#Malaysia>g%`.mt|q,*|G%#Malta>g%.mu|q,*|G%#Mauritius>g%`.mx|q,*|G%#Mexico>g%.co.ma|q,*|G%#Morocco>g%.nl|q,*|G%#Netherlands>g%.co.nz|q,*|G%#New Zealand>g%.no|q,*|G%#Norway>g%`.pk|q,*|G%#Pakistan>g%`.pe|q,*|G%#Peru>g%`.ph|q,*|G%#Philippines>g%.pl|q,*|G%#Poland>g%`.pr|q,*|G%#Puerto Rico>g%.ge|q,*|G%#Repulic of Georgia>g%.ro|q,*|G%#Romania>g%.ru|q,*|G%#Russia>g%.st|q,*|G%#Sao Tome and Principe>g%`.sg|q,*|G%#Singapore>g%.sk|q,*|G%#Slovakia>g%.si|q,*|G%#Slovenia>g%.es|q,*|G%#Spain>g%.lk|q,*|G%#Sri Lanka>g%.se|q,*|G%#Sweden>g%.ch|q,*|G%#Switzerland>g%`.tw|q,*|G%#Taiwan>g%.co.th|q,*|G%#Thailand>g%.bs|q,*|G%#The Bahamas>g%.tt|q,*|G%#Trinidad and Tobago>g%`.tr|q,*|G%#Turkey>g%`.ua|q,*|G%#Ukraine>g%.co.uk|q,*|G%#United Kingdom>g%`.uy|q,*|G%#Uruguay>g%.co.ve|q,*|G%#Venezuela>g%`.vn|q,*|G%#Viet Nam>g%.co.vi|q,*|G%#Virgin Islands>icqit`|q|icq>kvasir.no|q,searchExpr|Kvasir>bing`|q|Microsoft Bing>myway`|searchfor|MyWay.com>naver`,search.naver`|query|Naver>searchalot`|query,q|Searchalot>seznam|w|Seznam.cz>busca.uol`.br|q|UOL Busca>virgilio.it|qs|Virgilio>y^`,search.y^`|p|Y^!>au.y^`,au.search.y^`|p|Y^!#Australia>ca.y^`,ca.search.y^`|p|Y^!#Canada>hk.y^`,hk.search.y^`|p|Y^!#Hong Kong>malaysia.y^`,malaysia.search.y^`|p|Y^!#Malaysia>ph.y^`,ph.search.y^`|p|Y^!#Philippines>sg.y^`,sg.search.y^`|p|Y^!#Singapore>tw.y^`,tw.search.y^`|p|Y^!#Taiwan>uk.y^`,uk.search.y^`|p|Y^!#UK and Ireland>yandex|text|Yandex.ru>search.cnn.com|query|CNN Web Search>search.earthlink.net|q|Earthlink Search>search.comcast.net|q|Comcast Search>search.rr.com|qs|RoadRunner Search>optimum.net|q|Optimum Search";
/*
...
s.trackingServer="hallmarkcom.112.2o7.net"
