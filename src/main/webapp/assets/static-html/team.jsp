        ...
        <div class="team-container" data-bsp-dev-team>
            <div class="team-row" id="dev-team">
                ...
                <div class="team-card circle-card " id="darragh">
                    ...
                    <div class="text">
                        <h4 class="team-name">Darragh</h4>
                        <h5 class="team-pos">Dev Position</h5>
                    </div>
                    <div class="team-desc">
                ...
                <!-- Dev Card -->
                <div class="team-card " id="richard">
                    <div class="media">
                        <img src="http://lorempixel.com/220/220/people/2/">
                    </div>
                    <div class="text">
                        <h4 class="team-name">Richard Bodin</h4>
                        <h5 class="team-pos">Dev Position</h5>
                    </div>
                    <div class="team-desc">
                        <h4 class="desc-title">DevName role at DevEire</h4>
                ...
                <div class="team-card " id="ramon">
                    <div class="media">
                        <img src="http://lorempixel.com/220/220/people/3/">
                    </div>
                    <div class="text">
                        <h4 class="team-name">Ramon</h4>
                        <h5 class="team-pos">Dev Position</h5>
                    </div>
                    <div class="team-desc">
                        <h4 class="desc-title">DevName role at DevEire</h4>
                ...
                <div class="team-card " id="marie">
                    <div class="media">
                        <img src="http://lorempixel.com/220/220/people/4/">
                    </div>
                    <div class="text">
                        <h4 class="team-name">Marie</h4>
                        <h5 class="team-pos">Dev Position</h5>
                    </div>
                    <div class="team-desc">
                        <h4 class="desc-title">DevName role at DevEire</h4>
                ...
                <div class="team-card " id="matthew">
                    <div class="media">
                        <img src="http://lorempixel.com/220/220/people/3/">
                    </div>
                    <div class="text">
