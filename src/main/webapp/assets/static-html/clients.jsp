...
<div class="client-wrapper">
    <div class="client-page">
        ...
        <%-- end article layout --%>
        <div class="client-fluid-container">
            <div class="client-container" data-bsp-dev-clients>
                <div class="client-row">
                    <div class="client-wrapper">
                        <!-- Dev Card -->

                        <div class="client-card-outer" id="drivechipputt">
                            <div class="client-card">
                                <div class="media">
                                    <img src="/assets/images/work/dcp.png">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>Drvie Chip &amp Putt</h5>
                                </div> 
                        ...
                        <div class="client-card-outer" id="cocacola">
                            <div class="client-card">
                                <div class="media">
                                    <img src="/assets/images/work/coke.png">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>The Coca-Cola Company</h5>
                                </div> 
                                <div class="client-desc">
                                    <h4 class="desc-title">title</h4>
                                    <p class="desc-blurb">In leo lectus, tincidunt et cursus eget, dignissim at ante. Donec lacinia lorem ac nibh facilisis scelerisque. Sed lobortis maximus pharetra. Fusce lacinia neque ut molestie ornare. Sed vehicula ligula vel velit sollicitudin, ac ornare nunc placerat. Etiam a suscipit odio, id feugiat dolor. Donec enim tellus, molestie at fermentum at, convallis rhoncus nibh.<a href="#" class="lk-chevron-inverse">Read More</a> </p> 
                        ...
                        <div class="client-card-outer" id="cicso">
                            <div class="client-card">
                                <div class="media">
                                    <img src="/assets/images/work/cisco.jpeg">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>Cisco</h5>
                                </div>  
                                <div class="client-desc">
                                    <h4 class="desc-title">title</h4>
                                    <p class="desc-blurb">In leo lectus, tincidunt et cursus eget, dignissim at ante. Donec lacinia lorem ac nibh facilisis scelerisque. Sed lobortis maximus pharetra. Fusce lacinia neque ut molestie ornare. Sed vehicula ligula vel velit sollicitudin, ac ornare nunc placerat. Etiam a suscipit odio, id feugiat dolor. Donec enim tellus, molestie at fermentum at, convallis rhoncus nibh.<a href="#" class="lk-chevron-inverse">Read More</a> </p> 
                        ...
                        <div class="client-card-outer" id="walmart">
                            <div class="client-card">
                                <div class="media">
                                    <img src="/assets/images/work/emt.png">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>Walmart</h5>
                                </div>   
                                <div class="client-desc">
                                    <h4 class="desc-title">title</h4>
                                    <p class="desc-blurb">In leo lectus, tincidunt et cursus eget, dignissim at ante. Donec lacinia lorem ac nibh facilisis scelerisque. Sed lobortis maximus pharetra. Fusce lacinia neque ut molestie ornare. Sed vehicula ligula vel velit sollicitudin, ac ornare nunc placerat. Etiam a suscipit odio, id feugiat dolor. Donec enim tellus, molestie at fermentum at, convallis rhoncus nibh.<a href="#" class="lk-chevron-inverse">Read More</a> </p> 
                        ...
                        <div class="client-card-outer" id="usnews">
                            <div class="client-card">                        
                                <div class="media">
                                    <img src="/assets/images/work/usnews.png">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>U.S. News & World Report</h5>
                                </div>  
                                <div class="client-desc">
                                    <h4 class="desc-title">title</h4>
                                    <p class="desc-blurb">In leo lectus, tincidunt et cursus eget, dignissim at ante. Donec lacinia lorem ac nibh facilisis scelerisque. Sed lobortis maximus pharetra. Fusce lacinia neque ut molestie ornare. Sed vehicula ligula vel velit sollicitudin, ac ornare nunc placerat. Etiam a suscipit odio, id feugiat dolor. Donec enim tellus, molestie at fermentum at, convallis rhoncus nibh.<a href="#" class="lk-chevron-inverse">Read More</a> </p> 
                        ...
                        <div class="client-card-outer" id="mit">
                            <div class="client-card">
                                <div class="media">
                                    <img src="/assets/images/work/mit.jpeg">
                                </div>
                                <div class="text">
                                    <h5 class="client" data-bsp-truncate data-bsp-truncate-options='{"maxLines":2}'>MIT Sloan Executive Education</h5>
                                </div> 
                                <div class="client-desc">
                                    <h4 class="desc-title">title</h4>
                                    <p class="desc-blurb">In leo lectus, tincidunt et cursus eget, dignissim at ante. Donec lacinia lorem ac nibh facilisis scelerisque. Sed lobortis maximus pharetra. Fusce lacinia neque ut molestie ornare. Sed vehicula ligula vel velit sollicitudin, ac ornare nunc placerat. Etiam a suscipit odio, id feugiat dolor. Donec enim tellus, molestie at fermentum at, convallis rhoncus nibh.<a href="#" class="lk-chevron-inverse">Read More</a> </p> 
